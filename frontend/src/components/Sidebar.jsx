        ...
        <nav className="flex-1 px-3 py-4 space-y-4 overflow-y-auto">
          {navSections.map((section, secIdx) => (
            <div key={section.section} className="space-y-1">
              {!isCollapsed ? (
                <div className="px-3 pt-2 pb-1 text-[10px] font-extrabold text-slate-500 uppercase tracking-widest">
                  {section.section}
                </div>
              ) : (
                secIdx > 0 && <div className="my-2 border-t border-slate-800" />
              )}
