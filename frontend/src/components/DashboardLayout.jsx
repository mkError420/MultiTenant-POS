              ...
              <div className="relative">
                <button
                  ...
                  className={`relative p-2 text-slate-500 rounded-full hover:bg-slate-100 focus:outline-none ${
                    lowStockItems.length > 0 ? 'text-amber-500 hover:text-amber-600' : ''
                  }`}
                        ...
                        lowStockItems.map((item) => (
                          <div key={item.id} className="p-4 hover:bg-slate-50 transition-colors">
                            <div className="flex justify-between items-start">
                              ...
                              <span className="text-xs text-rose-500 font-bold bg-rose-50 px-2 py-0.5 rounded shrink-0">
                                Qty: {item.stock_quantity}
                              </span>
                            </div>
                            <p className="text-xs text-slate-500 mt-1">
                              Stock level is below threshold ({item.low_stock_threshold}). Please reorder.
                            </p>
                          </div>
                        ))
                      )}
